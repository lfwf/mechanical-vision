 ...
 *
 * 这些组件主要用于“零件拆装”模式：
 * - opacity 接近 1 时显示正常白色外壳；
 * - opacity 降低时切换为浅青色幽灵外壳，并关闭 depthWrite，减少透明面遮挡内部零件。
 *
 * 运行原理模式已经改用 SectionViewGeometry 中的简化骨架，不再依赖整块透明外壳。
 */
  ...
  return (
    <group>
      ...
      <mesh position={[0.66, 0, -0.02]}>
        <boxGeometry args={[0.07, 3.1, 1.6]} />
        <meshStandardMaterial color="#8d9794" metalness={0.55} roughness={0.29} />
      </mesh>
