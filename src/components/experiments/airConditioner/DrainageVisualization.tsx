...
export function DrainageVisualization() {
  ...
  return (
    <>
      ...
      <AnimatedFlowParticles active paths={CONDENSATION_PATHS} startColor="#d9f4fb" endColor="#79cce6" countPerPath={5} size={0.04} speedMultiplier={0.48} />
      <AnimatedFlowParticles active paths={PAN_FLOW_PATHS} startColor="#8dd8ed" endColor="#56aecf" countPerPath={4} size={0.043} speedMultiplier={0.72} />
      <AnimatedFlowParticles active paths={[DRAIN_LINE_PATH]} startColor="#7fd2eb" endColor="#318fbd" countPerPath={22} size={0.052} speedMultiplier={0.82} />
