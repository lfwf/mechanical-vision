  ...
  return (
    <group>
      <ExplodablePart id="wm-door" home={[0, 0.25, 2.48]} exploded={[-3.7, 0.25, 5.8]} assemblyEnabled={assemblyEnabled} selectionRadius={1.42}>
        <mesh rotation={[Math.PI / 2, 0, 0]} castShadow><torusGeometry args={[1.3, 0.24, 28, 72]} /><meshStandardMaterial color="#50666b" metalness={0.42} roughness={0.28} /></mesh>
      ...
      <ExplodablePart id="wm-bellow-outer-clamp" home={[0, 0.25, 2.23]} exploded={[0, 0.25, 5.55]} assemblyEnabled={assemblyEnabled} selectionRadius={1.3}>
        <mesh rotation={[Math.PI / 2, 0, 0]}><torusGeometry args={[1.38, 0.025, 10, 72]} /><meshStandardMaterial color="#9ba6a4" metalness={0.75} roughness={0.2} /></mesh>
      ...
      <ExplodablePart id="wm-bellow-inner-clamp" home={[0, 0.25, 1.72]} exploded={[2.95, 0.25, 4.15]} assemblyEnabled={assemblyEnabled} selectionRadius={1.42}>
        <mesh rotation={[Math.PI / 2, 0, 0]}><torusGeometry args={[1.44, 0.028, 10, 72]} /><meshStandardMaterial color="#87928f" metalness={0.72} roughness={0.24} /></mesh>
      </ExplodablePart>

      <ExplodablePart id="wm-bellow" home={[0, 0.25, 1.84]} exploded={[3.7, 0.45, 3.6]} assemblyEnabled={assemblyEnabled} selectionRadius={1.42}>
        <mesh rotation={[Math.PI / 2, 0, 0]} castShadow><torusGeometry args={[1.38, 0.3, 28, 72]} /><meshStandardMaterial color="#697775" roughness={0.58} /></mesh>
        <mesh position={[0, -1.3, 0.03]} rotation={[Math.PI / 2, 0, 0]}><torusGeometry args={[0.22, 0.045, 12, 36, Math.PI]} /><meshStandardMaterial color="#566563" roughness={0.55} /></mesh>
      </ExplodablePart>
    </group>
  );
}
