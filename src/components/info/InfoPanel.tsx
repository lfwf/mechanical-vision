import { ArrowDownRight, ArrowUpRight, Gauge, Info, MoveRight, Ratio } from "lucide-react";
  ...
  return (
    <aside className="info-panel">
      <div className="info-panel-head">
        <div>
          <div className="eyebrow">实时分析</div>
          <h2>传动结果</h2>
        </div>
      ...
      <div className="metric-grid">
        ...
        <article className="metric-card metric-card-wide">
          ...
          <small>理想扭矩倍率 × {formatNumber(analysis.torqueFactor, 2)}</small>
        </article>
      </div>
